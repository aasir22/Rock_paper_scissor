...
class Training:
    ...
    def train(self):
        ...
        try:
            ...
            self.log_object.log(self.file_object, f"Entered in to train method in Training class.classification report {classification_report}")
...
if __name__ == "__main__":
    train_path = "final_data_set/train"
    test_path = "final_data_set/test"
    val_path = "final_data_set/val"
